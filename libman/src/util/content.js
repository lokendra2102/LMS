...
const searchComponent = [
    ...
    "Dynamic login",
    "Multi select",
    "Restrict permission to other operators",
    "Track Status",
    "Update portal",
    "Export data from Pega Application to Excel File",
    "Mobile-OTP",
    "Email-OTP",
    ...
    "SysAdmin",
    "User Interface",
    "Retrieve data from Datatypes",
    "savables",
    "IFSC code Impl",
    "Service-Connect REST",
    "Service-Connect SOAP",
    "Delegation",
    "Using the Activity to Store the records",
    "Activity Validation",
    "Update Details",
    "Call the Activity by the Another Activity",
    "Copy the data from one data page to another data page",
    "Update the stock details in the same table by using the Activity",
    "Random 10 Number Generation Code-",
    "VISIBLE CONDITIONS: BY Access Groups",
    "DOB by Age",
    "User ID",
    "Email ID Code",
    ...
    "CVV validation",
    "Pin Code",
    "To get a future date from today",
    "To get Current Date",
    "DATE OF BIRTH: (MUST BE IN PAST)",
    "Mobile Number that starts with 6 or 7 or 8 or 9",
    "Age Calculations",
    "Notice Period in Pega",
    "Split date from current System date",
    "Validating the Age with Date of Birth",
